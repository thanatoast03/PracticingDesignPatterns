...
public class Singleton {
    ...
    private Singleton() {} // Constructor must be private so only access to Creational.Singleton object is through getInstance() func
        ...
        if (instance == null) {
            synchronized (Singleton.class) { // Makes thread safe
                if (instance == null) { // Check again because multiple threads can reach the first check state
                    System.out.println("Creating a new instance of Creational.Singleton");
